...
KERNEL_FQ KERNEL_FA void m23411_init (KERN_ATTR_TMPS_ESALT (generic_io_tmp_t, bitwarden_server_double_salt_t))
{
...
KERNEL_FQ KERNEL_FA void m23411_loop (KERN_ATTR_TMPS_ESALT (generic_io_tmp_t, bitwarden_server_double_salt_t))
{
}

KERNEL_FQ KERNEL_FA void m23411_comp (KERN_ATTR_TMPS_ESALT (generic_io_tmp_t, bitwarden_server_double_salt_t))
{
  /**
   * base
   */
